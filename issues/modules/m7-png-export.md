...
- #48 `M7-01` 捕获契约：定义 Renderer 到导出的场景捕获输入输出
- #49 `M7-02` 合成边界：定义 PNG 包含的场景、路线、标注与排除的编辑 UI
- #50 `M7-03` 输出预设：定义双 A4 尺寸、背景、像素比和导出范围
- #51 `M7-04` PNG 回归：定义同一 revision 的输出稳定性与作者验收证据
